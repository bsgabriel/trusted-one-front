    ...
    <div class="row items-start q-mb-md">
      <div class="col">
        <h4 class="text-h4 q-my-none q-mb-xs">
          <q-icon name="work" class="q-mr-sm gt-xs" />
          Especializações
        </h4>
        <p
        ...
        >
          Gerencie as especializações disponíveis
        </p>
      </div>
      <div class="col-auto">
        <q-btn
          color="primary"
          icon="add"
          :label="$q.screen.gt.xs ? 'Nova Especialização' : ''"
          @click="showAddExpertise"
          unelevated
          :round="$q.screen.xs"
        >
          <q-tooltip v-if="$q.screen.xs">Nova Especialização</q-tooltip>
        </q-btn>
      </div>
    </div>
