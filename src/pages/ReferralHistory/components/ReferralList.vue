        ...
        <q-list>
          ...
          <q-item>
            <q-item-section>
              ...
              <q-chip :color="getStatusColor(selectedReferral.status)" text-color="white" size="md">
          ...
          <q-item>
            <q-item-section>
              ...
              <q-item-label>{{ selectedReferral.createdAt.toLocaleString('pt-BR') }}</q-item-label>
            </q-item-section>
          </q-item>
          ...
          >
            <q-item-section>
              ...
              <q-item-label>{{ selectedReferral.updatedAt.toLocaleString('pt-BR') }}</q-item-label>
            </q-item-section>
          </q-item>
        </q-list>
      </q-card-section>
